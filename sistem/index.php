...
if(isset($_POST['simpan'])) {
  ...
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
      ...
      <head>
        ...
        <title>Pemilihan Ketua Umum Hipma Unikom</title>
        <!---------------------------------------------------------------------->
        ...
        <div class="adjust-nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
              <img style="padding: 5px; float: left; width: 20%; height: 50px;"src="assets/img/logo.png">
              <h4 style="color: white;">Pemilihan Ketua Umum Hipma Unikom</h4>
            </a> 
          </div>
          ...
          <div class="menu">
            <ul class="nav" id="main-menu">
              ...
              if($level){
                ...
                <li>
                  <a href="input_data_paslon.php"><i class="fa fa-user "></i>Input Data Caketum</a>
                </li>
          ...
          <div class="row">
            <div class="col-lg-12 ">
              <div class="alert alert-info">
                <strong><h2><b>Wilujeng Sumping,</b></h2></strong>
                <b style="font-size: 18px;"><?php echo $_SESSION['nama_mhs']; ?></b> Di Pemilihan Ketua Umum Hipma Unikom
              </div>   
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h2 align="center"><b>Calon Ketua Umum</b></h2><br>
                  <form action="" method="post">
                    ...
                    while($d = mysqli_fetch_array($data_paslon)){
                      ...
                      <div class="col-lg-6">
                        <table class="table table-striped table-bordered table-hover">
                          ...
                          <tr>
                            <td><center>
                              <img style="width: 50%; height: 50%;" src="<?php echo "foto/".$d['gambar1']; ?>">
                            </td></center>
                          </tr>
                          <tr>
                    ...
                    <!-- <table>
                      <tr>
                        <td>Visi
                          <ul type="none">
                            <li>Menjadikan HIPMA sebagai organisasi yang berintegritas tinggi dalam wadah kewirausahaan.</li>
                          </ul>
                        </td>
                        <td>Visi
                          <ul type="none">
                            <li>Menjadikan HIPMI PT. UNIKOM sebagai wadah untuk menciptakan pengusaha muda yang kreatif, mandiri, unggul, dan berkompeten untuk HIPMI PT. UNIKOM yang lebih baik.</li>
                          </ul>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          ...
                          <ol>
                            <li>Menjadikan HIPMA sebagai organisasi yang berintegritas tinggi dalam wadah kewirausahaan.</li>
                            <li>Meningkatkan professionalitas keanggotaan.</li>
                            <li>Edukasi bisnis guna meningkatkan kemampuan dalam berbisnis.</li>
                          </ol>
                        </td>
                      </tr>
                    </table> -->
  ...
  <div class="footer">
    <div class="row">
      <div class="col-lg-12" >
        &copy; Copyright HIPMA UNIKOM <?php echo date('Y') ?> <a href="http://binarytheme.com" style="color:#fff;" target="_blank"></a>
      </div>
    </div>
  </div>
